...
def main():
    cls(36)
    taskbar()
    spr(0,173,4,LOST1_SPR)
    spr(0,173,15,LOST2_SPR)
    window(10,5,230,100,9,"Explorer")
    vputs(10, 18, 0, "БИЛЛ ГЕЙТС ХОТЕЛ НА ГНУ/ЛИНУКС\nВОТ ТЕБЕ :fig:\nХА:abaudna:\nГНУ/ЛИНУКС МАТУШКА:abaudna::fig:\nГНИЛАЯ ВИНДОВС СКОРО ПОМРЕТ:fig:\nНАШ ЛИНУКСОИДНЫЙ ДУХ НЕ СЛОМИТЬ:strong:\nМАЙКРОСОФТ БУДЕТ НАША :ura:")
    vflush()
